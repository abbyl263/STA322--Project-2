...
This code relevels the factors to obtain the 95% CI for the other 15 helicopter designs. The results show that the baseline helicopter configuration, with all treatments at their low levels, has the highest 95% confidence interval.
```{r}
